...
@section('title', 'Sunting Data sekretariat Unit Kerja')
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title"><strong>Sunting Data sekretariat Unit Kerja</strong></h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form id="quickForm" action="{{route('admin.sekretariat.update')}}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      @if($fetch->img)
                        <div class="pt-2 mt-2">
                          <img width="400px" height="auto" src="{{asset('/storage/sekretariat/images/'.$fetch->img)}}" alt=""><br>
                          {{$fetch->img}}
                        </div>
                      @else

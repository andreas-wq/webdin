...
class SliderController extends Controller
{
    ...
    public function store(Request $request){
      ...
      try{
        ...
        $image = Storage::disk('local')->delete('storage/slider/images/'.$data->img);
        DB::rollback();
        $error = $e->getMessage();
        return redirect()->route('admin.slider.list')->with(['error' => $error]);
      }
    ...
    public function delete(Request $request){
      try{
        ...
        $image = Storage::disk('local')->delete('storage/slider/images/'.$basenameImg);
        $slider->delete();
    ...
    public function bindData($request){
      ...
      if(!empty($request->file('img'))){
        ...
        $img = $image->hashName();
        $image->storeAs('storage/slider/images', $img);
      } else {
        $img = null;
      }
      $data = [

...
class AgendaController extends Controller
{
    ...
    public function store(Request $request){
      try{
        ...
        if(!empty($request->file('img'))){
          ...
          $img = $image->hashName();
          $image->storeAs('storage/agenda/images', $img);
        } else {
          $img = null;
        }
        $data['img'] = $img;
    ...
    public function update(Request $request){
      try{
        ...
        if($request->file('img') == '') {
            ...
            $images = Storage::disk('local')->delete('storage/agenda/images/'.$basename);            
            //upload image baru
            $image = $request->file('img');
    ...
    public function delete(Request $request){
      try{
        ...
        $basename = basename($agenda->img);
        $image = Storage::disk('local')->delete('storage/agenda/images/'.$basename);
        $agenda->delete();

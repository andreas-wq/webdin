        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                ...
                <span class="text-white"><label
                        class="badge badge-success">{{ $user->getRoleNames()[0] }}</label></span>
            </div>
        </div>
        <div class="user-panel mt-2 pb-3 mb-3 d-flex">
            <div class="info">
                <a href="#" class="d-block"><span
                        class="text-white"><strong>{{ Auth::user()->name }}</strong></span></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    <a href="{{route('admin.dashboard.public')}}"
                        class="nav-link {{ Request::routeIs('admin.dashboard.public') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                        <p>
                            Dashboard Public
                        </p>
                ...
                <li class="nav-item">
                <li
                    class="nav-item has-treeview {{ Request::routeIs('admin.field.*')||Request::routeIs('admin.staff.*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.desa.list')}}"
                                class="nav-link {{ Request::routeIs('admin.desa.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.jenis_bencana.list')}}"
                                class="nav-link {{ Request::routeIs('admin.jenis_bencana.*') ? 'active' : '' }}">
                                <i class="far fa-file nav-icon"></i>
                                <p>Jenis Bencana</p>
                            </a>
                        </li>
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.bencana.list')}}"
                                class="nav-link {{ Request::routeIs('admin.bencana.*') ? 'active' : '' }}">
                                <i class="far fa-file nav-icon"></i>
                                <p>Bencana</p>
                            </a>
                        </li>
                ...
                <li
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <!-- <li class="nav-item pl-2">
                            <a href="{{route('admin.sekretariat.list')}}"
                                class="nav-link {{ Request::routeIs('admin.sekretariat.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.field.list')}}"
                                class="nav-link {{ Request::routeIs('admin.field.*') ? 'active' : '' }}">
                                <i class="fas fa-briefcase nav-icon"></i>
                                <p>Bidang</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="{{route('admin.agenda.list')}}"
                ...
                <li class="nav-item">
                    <a href="{{route('admin.announcement.list')}}"
                        class="nav-link {{ Request::routeIs('admin.announcement.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                <li
                    class="nav-item has-treeview {{ Request::routeIs('admin.category.*')||Request::routeIs('admin.tag.*')||Request::routeIs('admin.article.*')||Request::routeIs('admin.comment.*')||Request::routeIs('admin.trash.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.tag.list')}}"
                                class="nav-link {{ Request::routeIs('admin.tag.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                <li
                    class="nav-item has-treeview {{ Request::routeIs('admin.album.*')||Request::routeIs('admin.photo.*')||Request::routeIs('admin.video.*')||Request::routeIs('admin.infographic.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.album.list')}}"
                                class="nav-link {{ Request::routeIs('admin.album.*')||Request::routeIs('admin.photo.*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item pl-2">
                            <a href="{{route('admin.infographic.list')}}"
                                class="nav-link {{ Request::routeIs('admin.infographic.*') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="{{route('admin.website.setting')}}"
                        class="nav-link {{ Request::routeIs('admin.website.*') ? 'active' : '' }}">
                        <i class="fas fa-house-user nav-icon"></i>
                        <p class="text">Situs</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('admin.socmed.list')}}"
                        class="nav-link {{ Request::routeIs('admin.socmed.*') ? 'active' : '' }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-success"
                    onclick="event.preventDefault();document.getElementById('logout-form').submit();">Iya</button>

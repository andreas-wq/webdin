                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Jenis Bencana Terbaru</h3>
                            <a href="{{route('admin.jenis_bencana.create')}}" class="btn btn-success float-right">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.jenis_bencana.edit',['id' => $row->id])}}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="hapus-data" action="{{ route('admin.jenis_bencana.delete') }}"

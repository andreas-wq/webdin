          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Sekretariat Unit Kerja</h3>
                <a href="{{route('admin.sekretariat.create')}}" class="btn btn-success float-right">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $row->status }}</td>
                      <td>
                        <a href="{{route('admin.sekretariat.edit',['id' => $row->id])}}" class="btn btn-md btn-success btn-icon" title="Edit">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form id="hapus-data" action="{{ route('admin.sekretariat.delete') }}" method="POST" class="d-none">
                              @csrf

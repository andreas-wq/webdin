            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><small><strong>Kecamatan</strong></small></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Kecamatan Terbaru</h3>
                            <a href="{{route('admin.kecamatan.create')}}" class="btn btn-success float-right">
                                <i class="fas fa-plus-square"></i> Tambah Data
                            </a>
                            {{-- <a href="{{route('admin.field.export')}}" class="btn btn-success float-right mr-1">
                                <i class=""></i> Import Excel
                              </a> --}}
                              {{-- <a href="{{route('admin.field.export')}}" class="btn btn-info float-right mr-1">
                                <i class=""></i> Export Excel
                              </a> --}}
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.kecamatan.edit',['id' => $row->id])}}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form id="hapus-data" action="{{ route('admin.kecamatan.delete') }}"
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form id="quickForm" action="{{route('admin.kecamatan.import')}}" method="post" enctype="multipart/form-data">
          @csrf
        <div class="modal-body">

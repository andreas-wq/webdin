                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        <div class="card-header">
                            <h3 class="card-title"><strong>Tambahkan Data Bencana</strong></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="quickForm" action="{{route('admin.bencana.add')}}" method="POST">
                            {{csrf_field()}}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2  " name="desa_id"
                                                ...
                                                <option value="{{$list->id}}">Desa {{$list->name}} | Kecamatan :
                                       ...
                                       <div class="card card-success">
                                        ...
                                        <div class="card-body text-center ">
                                            <table class="table table-sm table-bordered ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><input type="text" class="" name="m_mkk" size="2"></th>
                                                        <th><input type="text" class=""name="m_mjw" size="2"></th>
                                                        <th><input type="text" class=""name="m_hlg" size="2"></th>
                                                        <th><input type="text" class=""name="m_md" size="2"></th>
                                                        <th><input type="text" class=""name="m_lk" size="2"></th>
                                                        <th><input type="text" class=""name="m_tkk" size="2"></th>
                                                        <th><input type="text" class=""name="m_tjw" size="2"></th>
                                              ...
                                              <table class="table table-sm table-bordered ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><input type="text" class="ss" name="r_hcr" size="2"></th>
                                                        <th><input type="text" class="ss"name="r_rb" size="2"></th>
                                                        <th><input type="text" class=""  name="r_rs"size="2"></th>
                                                        <th><input type="text" class="" name="r_rr"size="2"></th>
                                                        <th><input type="text" class="" name="r_trc"size="2"></th>
                                              ...
                                              <table class="table table-sm table-bordered ">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th><input type="text" class="ss" name="sl_trd" size="2"></th>
                                                        <th><input type="text" class="ss"name="sl_skl"  size="2"></th>
                                                        <th><input type="text" class="" name="sl_ti"  size="2"></th>
                                                        <th><input type="text" class=""name="sl_swh"  size="2"></th>
                                                        <th><input type="text" class="" name="sl_drt" size="2"></th>
                                                        <th><input type="text" class=""name="sl_empg"  size="2"></th>
                                                        <th><input type="text" class=""name="sl_jtrd"  size="2"></th>
                                                        <th><input type="text" class="" name="sl_jtrc" size="2"></th>
                                                        <th><input type="text" class="" name="sl_pts" size="2"></th>
